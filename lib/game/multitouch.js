...
.defines(function() {
  ...
  ig.Input.inject({
	...
	keydown: function( e ) {
	  ...
	  if ( e.type == 'mousedown' ) {
		this.touches.mouse ={oX: this.mouse.x, oY: this.mouse.y, x: this.mouse.x, y: this.mouse.y, id: 'mouse', state: 'down' };
	  }
	},
	...
	multitouchstart: function( x, y, id ) {
	  ...
	  this.touches[ id ] = { x: x, y: y, oX: x, oY: y, id: id, state: 'down' };
	},
